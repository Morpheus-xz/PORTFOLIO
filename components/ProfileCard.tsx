            ...
            <div className="pc-inside flex flex-col items-center justify-center p-8 text-center bg-[#030303]">
              ...
              <div className="flex flex-col gap-3 w-full max-w-[240px]">
                ...
                <a
                  ...
                  className="flex items-center gap-4 px-4 py-3 rounded-xl border border-white/5 bg-white/[0.02] transition-all duration-300 group/link hover:border-[#B19EEF]/30 text-[#d6c9ff]"
                >
                  <div className="w-8 h-8 rounded-lg bg-black/80 flex items-center justify-center border border-white/5 group-hover/link:border-[#B19EEF]/40 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-current">
                      <path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Zm0 4.24-7.38 4.92a1 1 0 0 1-1.24 0L4 8.24V6.8l7 4.66 1 .67 1-.67 7-4.66v1.44Z" />
                    </svg>
                  </div>
                  <span className="text-[10px] font-bold tracking-[0.2em] uppercase opacity-70 group-hover/link:opacity-100">Email</span>
                </a>
              </div>
